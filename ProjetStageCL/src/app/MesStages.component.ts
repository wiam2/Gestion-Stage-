      ...
      <table mat-table [dataSource]="dataSource" class="mat-table">
        ...
        <ng-container matColumnDef="actions">
          ...
          <td mat-cell *matCellDef="let element">
            <button mat-icon-button color="primary" (click)="valider(element.id)">
...
export class MesStagesComponent  implements OnInit {
  displayedColumns: string[] = ['Sujet', 'typeStage', 'Entreprise', 'actions'];
  ...
  loadStage() {
    this.stageService.getStages( this.etudiant.id).subscribe(
      (data: stage[]) => {

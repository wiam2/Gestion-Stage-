...
import com.retaiontest.relationtest.repository.PostRepository;
...
public class PostService {
    ...
    public Post registerPostWithUserAuthentifie(Post post) throws DataInvalid {
        ...
        post.setFiliere(post.getFiliere());
        post.setTypeStage(post.getTypeStage());
...
//    }
    ...
    public List<Post> afficherPostByFiliere(FILIERE filiere) throws DataInvalid {
        ...
        for (Post post : allPosts) {
            ...
            if (filiere.name().equalsIgnoreCase(post.getFiliere())) {
